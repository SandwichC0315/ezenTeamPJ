...
public class ProductController {
	...
	public String list(Locale locale, Model model,HttpServletRequest req,HttpServletResponse response ,int Pidx)throws ServletException, IOException {
		//int Pidx를 씀으로 인해 전 페이지에서 Pidx를 받아올 수 있는 것 같다.
		...
		ProductReviewVO svo = ProductService.AvgRscore(Pidx);//요기서 pidx를 담았어
		model.addAttribute("svo", svo);//view에 뿌리기 위해서 담는거 아닌가?  12/19일
