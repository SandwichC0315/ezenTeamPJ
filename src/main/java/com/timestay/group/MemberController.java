...
public class MemberController {
	...
	public String login(MemberVO vo, HttpServletRequest req, HttpServletResponse res) throws Exception{
		...
		else
		{
			...
			pw.append("<script>alert('아이디와 비밀번호를 확인해주세요.');location.href='javascript:history.back();'</script>");
	...
	public @ResponseBody String findPw(MemberVO vo) throws Exception {
		...
		if(vo1!=null) {
			...
			String securePw = encoder.encode(vo1.getMpwd());
