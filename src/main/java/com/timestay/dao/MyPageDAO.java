...
public class MyPageDAO {
	...
	public int ShoppingCartDelete(int Sidx) {
		// TODO Auto-generated method stub
		return sqlSession.delete("com.timestay.mapper.MyPageMapper.ShoppingCartDelete", Sidx);
	}
	public int ShoppingCartModify(ShoppingCartVO Svo) {
		
		return sqlSession.update("com.timestay.mapper.MyPageMapper.ShoppingCartModify", Svo);
	}
	public List<ShoppingCartVO> ShoppingCartPidx(ShoppingCartVO Svo ) {
		
		return sqlSession.selectList("com.timestay.mapper.MyPageMapper.ShoppingCartPidx", Svo);
	}
	public MemberVO selectUser(int Midx) {
		return sqlSession.selectOne("com.timestay.mapper.MyPageMapper.selectUser", Midx);
	}
}
