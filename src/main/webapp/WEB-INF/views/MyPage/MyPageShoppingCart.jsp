 ...
 <main> 
        ...
        <div id="contents">
            <div class="contbox">
				...
				<div class="cart_box">
              	  <form  action='${pageContext.request.contextPath}/MyPage/ShoppingCartBuy.do' method="post">
					    ...
					    <c:forEach var='Svo' items='${Svo}'>                        
                            <li class="nolist">
	                            ...
	                            <div class="box_cell box_5">
	                           	<form  action='${pageContext.request.contextPath}/MyPage/ShoppingCartModify.do' method="post">
                            	...
                            	<form action='${pageContext.request.contextPath}/MyPage/ShoppingCartDelete.do' method="post">
	                            	<input type="hidden" name="Sidx" value="${Svo.getSidx()}">
