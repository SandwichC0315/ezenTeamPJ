	...
	<header id="header" class="deactive">
							...
							<ul>
								...
								<li><a
									href="<%=request.getContextPath()%>/Board/BoardFaq.do">자주
										묻는 질문</a></li>
								<li><a
									href="<%=request.getContextPath()%>/Board/BoardQna.do">1:1
										문의 게시판</a></li>
		...
		<c:if test="${login==null}">
			<ul class="navbar_links">
				...
				<li><a
					href="<%=request.getContextPath()%>/Shopping/ShoppingCart.do">장바구니</a></li>
				<li><a href="#">고객센터</a></li>
			</ul>
		</c:if>
		<c:if test="${login!=null}">
			<ul class="navbar_links" style="width: 330px;">
				...
				<li><a
					href="<%=request.getContextPath()%>/Shopping/member_Modify.do?Mid=${Mid}"
		...
		<section id="order">
			...
			<form class="frm" action="post">
				<table class="pd_n">
					...
					<c:forEach var='svoChecked' items='${svoChecked}'>
						<tr class="pd_n_bottom">
							<td style="width: 50%">
								<div>
									<img
										src="${pageContext.request.contextPath}/resources/images/${svoChecked.getPimage()}">
									<p>${svoChecked.getPtitle()}</p>
								</div>
							</td>
							<td class="td1" style="width: 10%;"></td>
							<td style="width: 10%;">${svoChecked.getSvol()}</td>
							<td style="width: 10%;">${svoChecked.getPprice()}원</td>
							<td style="width: 10%;">${svoChecked.getTotalSum()}원<input
								type="hidden" name="TotalSum"
								value="${svoChecked.getTotalSum()}"></td>
				...
				<table class="pd_c">
					<tr class="pd_c_top">
						<td><p>주문금액:</p><input type="hidden" class="finalSum" name="finalSum" value="0"><p></p></td>
						<td><p>할인금액:</p></td>
						<td><p>결제예정금액:</p><input type="hidden" class="finalTotalSum" name="finalTotalSum" value="0"><p></p></td>
					</tr>
				</table>
