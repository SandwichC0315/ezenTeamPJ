...
<header id="header" class="deactive">
 ...
 <main> 
        ...
        <nav id="lnb">
            <ul>
                <li class="on">
                    <a href="<%=request.getContextPath()%>/Shopping/ShoppingCart.do">장바구니</a>
                </li>
                <br>
                <li>
                    <a href="<%=request.getContextPath()%>/Shopping/ShoppingOrderView.do">주문배송조회</a>
                </li>
                <br>
            </ul>
        </nav>
        ...
        <div id="contents">
            <div class="contbox">
				...
				<div class="cart_box">
              	  <form  action='${pageContext.request.contextPath}/Shopping/ShoppingCartBuy.do' method="post">
                    <div class="table_list">
					    ...
					    <c:forEach var='Svo' items='${Svo}'>                        
                            <li class="nolist">
	                            <div class="box_cell box_1"><input onclick="DelChk();" style="margin:0px 10px" name="pidxList" type="checkbox" data-value="${Svo.getTotalSum()}" value="${Svo.getPidx()}" ></div>
	                            <div class="box_cell box_2"><img style="width:100px; margin-left:20px;" src= "${pageContext.request.contextPath}/resources/images/${Svo.getPimage()}" ></div>
	                            ...
	                            <div class="box_cell box_5">
	                           	<form  action='${pageContext.request.contextPath}/Shopping/ShoppingCartModify.do' method="post">
                            		...
                            		<br/> 
	                            	<button style="width:60px; height:30px; margin: 10px 20px 0 20px;" >수정</button>                           	
   	                            </form>
                            	<form action='${pageContext.request.contextPath}/Shopping/ShoppingCartDelete.do' method="post">
	                            	<input type="hidden" name="Sidx" value="${Svo.getSidx()}">
                            		<button style="width:60px; height:30px; margin: 10px 20px 0 20px;">삭제</button>
                            	</form>
	                            </div>
	                            <div class="box_cell box_7 ">
	                            	${Svo.getTotalSum()}
	                            	<input type="hidden" class="ProductTotalSum" name="totalSumList" value="${Svo.getTotalSum()}">
									<input type="hidden" name="Ptitle" value="${Svo.getPtitle()}">
									<input type="hidden" name="Pimage" value="${Svo.getPimage()}">
									<input type="hidden" name="delivery" value="택배"> <!-- 이름 , 이미지 , 배송수단 -->
                          		</div>
                            </li>
                    	 </c:forEach>                            
                        </ul> 
	                        <div style="display:flex; justify-content:flex-end; align-items: center;">                   	 
							    <strong class="CheckedTotalSum" >0원</strong>     
								<input type="hidden" class="CheckedTotalSum" name="finalTotalSum" value="0">							                     		
