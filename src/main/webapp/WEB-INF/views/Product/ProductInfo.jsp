        ...
        <nav class="navbar">
     	...
     	<c:if test ="${login!=null}">
	        <ul class="navbar_links" style="width:330px;">
	            ...
	            <li><a href="<%=request.getContextPath()%>/Shopping/member_Modify.do?Mid=${Mid}" style="padding:0 4px">마이페이지</a></li>
		            ...
		            class TabsAutomatic {
		              ...
		              $('.btn-open-popup').on("click",function(){
				       ...
				       //
		        		...
		        		if(ShoppingCart != ""){
		        			$.ajax({
		        				url:"${pageContext.request.contextPath}/Shopping/ShoppingCartAjax.do",
		        				type:"get",
