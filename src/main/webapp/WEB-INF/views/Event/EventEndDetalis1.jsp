          ...
          <td colspan="2">
            ...
            <div class="datail">
              <div class="fr-view fr-view-artice">
                ...
                <p></p>
                <center>
                  <a href="<%=request.getContextPath()%>/Event/EventEndEvent.do">
                    <img src="${pageContext.request.contextPath}/resources/Symbol/icon_event4.jpg">
                  </a>
                </center>
                <p></p>
                <p>
