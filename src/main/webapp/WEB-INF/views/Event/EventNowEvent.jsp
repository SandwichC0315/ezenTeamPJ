...
<header id="header" class="deactive">
	...
	<div id="contents">
		...
		<div class="DB_board_cate">
			...
			<li class="false"><a href="<%=request.getContextPath()%>/Event/EventNowEvent.do" style="color:black">[진행중]</a></li>

			<li class="false"><a href="<%=request.getContextPath()%>/Event/EventEndEvent.do">[종료]</a></li>
		</div>


    <section id="main_view">
        <ul>
            <li><img src="${pageContext.request.contextPath}/resources/Symbol/icon_event.jpg" alt="메인뷰1" onclick="location.href='<%= request.getContextPath() %>/Event/EventNowDetalis1.do'"></li>
            <li><img src="${pageContext.request.contextPath}/resources/Symbol/icon_event2.jpg" alt="메인뷰2" onclick="location.href='<%= request.getContextPath() %>/Event/EventNowDetalis2.do'"></li>
            <li><img src="${pageContext.request.contextPath}/resources/Symbol/icon_event3.jpg" alt="메인뷰3" onclick="location.href='<%= request.getContextPath() %>/Event/EventNowDetalis3.do'"></li>
        </ul>
    </section>
